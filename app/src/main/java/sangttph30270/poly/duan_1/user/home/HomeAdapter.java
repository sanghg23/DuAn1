package sangttph30270.poly.duan_1.user.home;
...
import sangttph30270.poly.duan_1.activity.ItemInforCoffe;
import sangttph30270.poly.duan_1.user.cart.Cart;
import sangttph30270.poly.duan_1.user.cart.CartAdapter;
import sangttph30270.poly.duan_1.user.cart.CartDAO;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
       listCart=cartDAO.getAllData();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, ItemInforCoffe.class);
